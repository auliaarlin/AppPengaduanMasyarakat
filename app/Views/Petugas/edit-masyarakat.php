...
<input type="text" name="txtInputUsername" class="form-control" placeholder="Masukan username" value="<?=$detail[0]['username'];?>" autocomplete="off" autofocous reaquire >
</div>

<div class="form-group">
<label class="font-weight-bold">Password</label>
<input type="text" name="txtPassword" class="form-control" placeholder="Masukan password" value="<?=$detail[0]['password'];?>" autocomplete="off" autofocous reaquire >
</div>
