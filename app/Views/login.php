		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Form Login Aplikasi Pengaduan Masyarakat Desa Cikadu</h2>
				</div>
			</div>
			...
			<div class="row justify-content-center">
	          ...
	          <p class="w-100 text-center">&mdash; Belum punya akun? Silahkan Registrasi dibawah ini! &mdash;</p>
